...
export class Country1758267982620 implements MigrationInterface {
    name = 'Country1758267982620'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            CREATE TABLE "lib_contacts_countries" (
                "id" SERIAL NOT NULL,
        ...
        // await queryRunner.query(`ALTER TABLE public.lib_contacts ADD country_id bigint NULL;`);

        await queryRunner.query(`
            INSERT INTO lib_contacts_countries (name, code, phone_code)
            VALUES
                ('Afghanistan', 'AF', '+93'),
                ('Albania', 'AL', '+355'),
                ('Algeria', 'DZ', '+213'),
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            DROP TABLE "lib_contacts_countries"
        `);
